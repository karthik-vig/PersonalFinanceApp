...
function CheckboxOptionsMenu({checkBoxOptions=[], 
    ...
    return (
        ...
        >
            <div
                className="absolute top-[25%] left-[40%] p-2 h-40 w-[30%] flex flex-col flex-nowrap justify-center items-center border border-slate-400 rounded-md bg-slate-100"
            > 
                <section
                ...
                >
                    <button 
                        className="mx-1 border rounded-md bg-green-600 text-semibold text-white w-20 h-8 hover:bg-green-700 border-green-700"
                        onClick={handleProceed}
                    >
                        Proceed
                    </button>
                    <button 
                        className="mx-1 border rounded-md bg-red-600 text-semibold text-white w-20 h-8 hover:bg-red-700 border-red-700"
