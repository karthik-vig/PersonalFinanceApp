...
export const filterParamsVisibilitySlice = createSlice({
    name: "recurringEntityPage/filterParamsVisibility",
    initialState: {
            value: false,
            currency: false,
            ...
            recurringFrequencyType: false,
            recurringFrequencyDayOfTheWeek: false,
            recurringFrequencyDayOfTheMonth: false,
            recurringFrequencyMonthOfTheYear: false,
            recurringFrequencyTime: false,
            recurringTransactionStartDate: false,
            recurringTransactionEndDate: false,
            sort: false,
        },
    reducers: {
