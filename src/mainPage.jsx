...
function TopBarButton({ svgIcon, btnName, onClickHandler }) {
    return (
        <button className="my-3 mx-3 p-0.5 w-7 h-7 rounded-lg hover:bg-hover-cl outline outline-1 outline-gray-400 outline-offset-2 bg-surface-cl" onClick={()=>onClickHandler(btnName)}>
